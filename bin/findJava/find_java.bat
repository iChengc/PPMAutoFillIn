...
:CheckFailed
echo.
echo ERROR: No suitable Java found. You should install JDK.
xcopy \\asiashaf02\coe$\DEV\OneSource\Tools\For_Android\jdk-7u79-windows-x64.exe %cd%\jdk-7u79-windows-x64.exe /Y /E
call jdk-7u79-windows-x64.exe
DEL %cd%\jdk-7u79-windows-x64.exe /F /Q
goto :EOF
